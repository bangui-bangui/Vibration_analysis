...
void ui_Screen5_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Chart4, 693);
    lv_obj_set_height(ui_Chart4, 304);
    ...
    static lv_coord_t ui_Chart4_series_1_array[] = { 25, -25, 25, -25, 25, -30, 32, -28, 34, -36, 25, -28, 30, -36, 33, -27, 29, -37 };
